...
# XTerminals
-   Wikipedia has an _incomplete_ [w:List of terminal emulators].
...
The standard X [w:terminal emulator] is
...
There is also a fork for Wayland named [wterm](#wterm "internal reference").
In Debian _st_ is packaged a _stterm_.

There are also
a lot of alternate terminals like [w:rxvt],
...
homonym  Wayland terminal [wterm](#wterm "internal reference").
...
it is 7.3M/6.3M. This has not changed between [old test (1)
](#oldtest "internal reference") and [new 2015 test (2)
](#newtest15 "internal reference").
...
layout library like [w:pango] for GTK or libxrender1 for qt.
...
The Kde/Qt terminal is [w:Konsole] it has heavy KDE dependencies; but
...
shr [3](#newtest17 "internal reference") with 2 tabs.
...
Vte includes pango so it can display [w:OpenType]  fonts.
...
-   [evilvte](http://www.calno.com/evilvte/) (GPL)
    a light [vte](#vte "internal reference") terminal, but you have to
    recompile it to change the configuration. _It is no more
    developped since 2013 and no more in debian_
-   <a name="gnome-terminal"></a>[w:gnome terminal] (GPL)  build
    upon [vte](#vte "internal reference")
    ...
    [Mate Terminal](#mate-terminal "internal reference")
    are a good choice for a vte terminal supporting dbus, pango and
    advanced preferences.
    33M res / 25M shr [3](#newtest17 "internal reference"). _in
    Debian_.
    -   [Gnome Terminal Help
...
-   [Guake](https://github.com/Guake/guake)
    ...
    Footprints: 49M / 32M shr [3](#newtest17 "internal reference").
    _in Debian_.
...
-   [lilyterm](http://lilyterm.luna.com.tw/) (GPL)
    ...
    [3](#newtest17 "internal reference")
-   [lxterminal](http://lxde.org) (GPL) from lxde which is quite light.
    ...
    23M / 19M shr [3](#newtest17 "internal reference).<br />
...
-   [Pangoterm](http://www.leonerd.org.uk/code/pangoterm/)
    ...
    Memory footprints: 18M res. / 16M shared [(2)
    ](#newtest15 "internal reference").
...
-   [Sakura](http://www.pleyades.net/david/projects/sakura) (GPL),
    ...
    Footprints: 24M res / 27M shr [3](#newtest17 "internal reference"),
    _in Debian_
    -   [Sakura launchpad page](https://launchpad.net/sakura)_
-   [terminator](http://www.tenshu.net/p/terminator.html) build upon
    _python-vte_ arrange many [vte](#vte "internal reference")
...
-   [Termit](http://github.com/nonstop/termit/wiki) (GPL)
    ...
    Memory footprints: 34M/26M [3](#newtest17 "internal reference")
    for 2 tabs.
-   [Termite](https://github.com/thestinger/termite)
    [Archwiki: Termite](https://wiki.archlinux.org/index.php/Termite)
    is a minimal [vte](#vte "internal reference") terminal emulator
...
-   [Tilda](https://github.com/lanoxx/tilda) is a drop down
    ...
    There is a [w:Tilda_(software)|Wikipedia page].
    Footprints: 44M / 29M [3](#newtest17 "internal reference"),
    _in Debian_
...
A list of [vte](#vte "internal reference") terminals is on the
...
[old test (1)](#oldtest "internal reference") with only one tab;
...
the tab!_. If we go in details for 2 tabs for the [old test (1)
](#oldtest "internal reference") terminator use 40M since it
embeds python-vte; tilda, roxterm, gnome terminal use 16-18M, lilyterm
and sakura 14M lxterminal and evilvte 12M.

For the  [new test (2)
](#newtest15 "internal reference") or
[3](#newtest17 "internal reference"):
gnome-terminal 33M res / 25M shr [3](#newtest17 "internal reference"),
guake 49M / 32M shr [3](#newtest17 "internal reference"),
lilyterm 34M / 28M shr [3](#newtest17 "internal reference"),
lxterminal  24M / 20M shr [3](#newtest17 "internal reference"),
mate-terminal 42M / 30M shr [3](#newtest17 "internal reference"),
pangoterm 18M res. / 16M shared.
qterminal 34M / 29M shr [3](#newtest17 "internal reference"),
roxterm 21M res / 14M shr [3](#newtest17 "internal reference"),
sakura 24M res / 27M shr [3](#newtest17 "internal reference"),
st 7.7M/6.7M [3](#newtest17 "internal reference"),
terminator 55M / 33M shr [3](#newtest17 "internal reference"),
terminology 27.5M/18.6M [2](#newtest15 "internal reference"),
termit 21M/18M [2](#newtest15 "internal reference") 34M/26M
[3](#newtest17 "internal reference"),
tilda 44M / 29M [3](#newtest17 "internal reference"),
xterm 9.7M/5.8M [3](#newtest17 "internal reference").
...
Most terminals, both console and X support [w:ANSI escape code]
...
[vte](#vte "internal reference") terminals support 256 colors.
...
[w:ANSI escape code|XWikipedia: ANSI escape code]
...
In 256-color mode (ESC[38;5;<fgcode>m and ESC[48;5;<bgcode>m),
...
See also [Terminal multiplexers section
](/node/checkpointing#terminal_multiplexors "local reference").
